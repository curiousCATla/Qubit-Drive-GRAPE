...
# ============================================================
# PATH HANDLING (works whether run from artifacts/ or elsewhere)
# ============================================================
import sys
possible_paths = [
...
for p in possible_paths:
    if os.path.exists(os.path.join(p, "grape_core.py")):
        sys.path.insert(0, p)
        break

from grape_core import make_hamiltonian, step_data, basis_state
from cat_code import get_logical_cat_states, embed_in_joint_space
